...
2. Pilih aktiviti yang berkaitan
3. Klik pada tab **Output**
![](./images/output-pi-kemaskini.png)
4. Klik **PI** pada sudut kanan outcome yang berkaitan
...
2. Pilih aktiviti yang berkaitan
3. Klik tab **Output**
4. Klik **PI** pada output yang berkaitan 
![](./images/aktiviti_susun-pi1.png)
5. Klik butang **3 dots** 
6. Klik **Susun PI**
![](./images/aktiviti_susun-pi2.png)
7. Ubah susunan PI melalui kaedah _Drag and Drop_
8. Klik butang **Tetapkan**

<Callout title="Outcome">
Susunan PI berjaya dikemaskini
</Callout>
...
3. Klik pada tab **Output**
![](./images/output-pi-kemaskini.png)
4. Klik **PI** pada sudut kanan output yang berkaitan
5. Klik butang **Kemaskini** pada sudut kanan **PI**
![](./images/pi-butiran.png)
6. Klik butang **Padam**
