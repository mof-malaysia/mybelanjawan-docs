...
## Pemetaan Outcome MP kepada Outcome Nasional
Peranan: Penyedia MES / Pegawai Pengawal

<Callout title="Pra-syarat" type="warn"> 
Penyediaan outcome nasional telah selesai
</Callout>
...
<Callout title="Outcome">
Pemetaan outcome kementerian kepada outcome nasional telah selesai, proses penyediaan outcome program boleh bermula
</Callout>

## Ubah Susunan Outcome MP
Peranan: Penyedia MES / Pegawai Pengawal
...
2. Pilih maksud perbelanjaan yang berkaitan
3. Klik tab **Outcome**
![](./images/mp_susun-outcome1.png)
4. Klik butang **3 dots**
5. Klik **Susun Outcome**
![](./images/mp_susun-outcome2.png)
