...
1. Sila pastikan tetapan Tarikh & Masa (_Date & Time_) pada telefon bimbit/laptop/PC ditetapkan kepada automatik (_Set Automatically/Use Network-Provided Time_) serta mempunyai sambungan internet yang stabil.
2. Sila muat turun aplikasi _Google Authenticator_ pada _Google Play Store_ ataupun _Apple App Store_ pada telefon bimbit anda

Pautan muat turun aplikasi _Google Authenticator_ adalah seperti berikut:
...
* Sila pastikan kod 2FA 6 digit terdahulu pada aplikasi Google Authenticator dipadamkan bagi mengelakkan kekeliruan
</Callout>